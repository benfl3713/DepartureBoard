...
export class SettingsComponent implements OnInit {
  ...
  Load() {
    ...
    this.settingsForm.controls["general_dataSource"].setValue(localStorage.getItem("settings_general_dataSource") || "REALTIMETRAINS");
    //MainBoard Settings
  ...
  Save(showMessage:boolean = true) {
    ...
    localStorage.setItem("settings_general_dataSource", this.settingsForm.controls["general_dataSource"].value || "REALTIMETRAINS");
    //MainBoard Settings
